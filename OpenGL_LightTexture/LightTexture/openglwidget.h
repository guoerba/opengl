...
public:
    ...
    ~OpenGLWidget();
    void SetMetaMaterial(Material material, QOpenGLShaderProgram *pro = NULL);
    void SetTexMaterial(TexMaterial texmaterial,QOpenGLShaderProgram *pro = NULL);
    void SetLightStrength(Light light,QOpenGLShaderProgram *pro = NULL);
    enum Sampler2DN{
        SamplerDiffuse = 0,
        SamplerSpecular
    };
